...
class CheckpointCustom(tf.keras.callbacks.ModelCheckpoint):
...
def get_distill_callbacks(monitor, mode, save_path, _max_lr, _min_lr, _cos_anne_ep, save_weights_only):
    global max_lr
    max_lr = _max_lr
    global min_lr
    min_lr = _min_lr
